          ...
          <div key={index} className="py-4 border-t border-b text-gray-700 flex flex-col md:flex-row md:items-center md:justify-between gap-4">
            <div className="flex items-start gap-6">
              ...
              <div className="">
                ...
                <div className='flex items-center gap-5 mt-2 text-normal text-gray-500'>
            ...
            <div className="md:w-1/2 flex justify-between">
              ...
              <button onClick={() => alert('Tracking information will be available soon!')} className="border px-4 py-2 text-sm font-medium rounded-sm cursor-pointer">
                Track Order
              </button>
            </div>
          </div>
